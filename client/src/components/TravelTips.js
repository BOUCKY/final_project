    ...
    return(
        <div className='list-container'>
            ...
            <div className='tips-list'>
                ...
                <li>Slip-on shoes...Comfort is key because you'll walk way more when traveling. These make it way easier to fly through security...And make sure you wear socks if you'll be going through an airport. You don't want to walk barefoot through security!</li>
                <li>Always check the expiration date of your passport well before traveling. Many countries require six months of validity to grant entry.</li>
                <li>Get a credit card that includes airport lounge access. Flying will never be the same.</li>
                <li>Research your destination before you pack, so you know what you really need.</li>
                <li>Pack a change of underwear, a toothbrush, medications, some cash, and a charger in whatever bag will be on your body the entire time you're traveling.</li>
                <li>Plan ahead of time how you're going to get from the airport to your accommodation.</li>
                <li>Carry a tote bag or laundry bag to separate your dirty clothes in your suitcase.</li>
                <li>Pack an extra outfit in your carry-on, just in case.</li>
                ...
                <li>The best time to book any holiday is off-season, not only in your own country but also in the place you're travelling to.</li>
